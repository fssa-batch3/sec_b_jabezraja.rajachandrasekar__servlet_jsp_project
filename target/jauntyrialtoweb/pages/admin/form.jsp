			...
			<div class="admform">
				...
				<div>
					<label>Main Image</label>
					 	<input id="mimg" type="url" name="mainImg" placeholder="Image should be in url" name="mainIMG" required>
					<label>Sub Image 1</label>
					 	<input id="simg1" type="url" name="subImg1" placeholder="Image should be in url" name="subIMG1" required>
					<label>Sub Image 2</label>
					 	<input id="smig2" type="url" name="subImg2" placeholder="Image should be in url" name="subIMG2" required>
					<label>Sub Image 3</label>
					 	<input id="simg3" type="url" name="subImg3" placeholder="Image should be in url" name="subIMG3" required>
				</div>
			</div>
